    ...
    <div class="col-lg-11 col-md-11 col-sm-12 col-xs-12">
        <div class="card rounded-0 shadow">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-sm-12">
                            ...
                            <div class="pl-4">
                                <?= isset($datetime_start) ? date("M d, Y h:i A", strtotime($datetime_start)) : '' ?>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-sm-12">
                            ...
                            <div class="pl-4">
                                <?= isset($datetime_end) ? date("M d, Y h:i A", strtotime($datetime_end)) : '' ?></div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-sm-12">
            ...
            <div class="card-footer py-1 text-center">
                <a class="btn btn-info btn-sm bg-gradient-info rounded-0" href="javascript:void(0)" id="update_status">
                    Update Status</a>
                <?php if ($_settings->userdata('account_type') == 0) : ?>
                <a class="btn btn-primary btn-sm bg-gradient-primary rounded-0"
                    href="./?page=court_rentals/manage_court_rental&id=<?= isset($id) ? $id : '' ?>"><i
                        class="fa fa-edit"></i> Edit</a>
                <button class="btn btn-danger btn-sm bg-gradient-danger rounded-0" type="button" id="delete-data"><i
...
$(document).ready(function() {
    $('#update_status').click(function() {
        uni_modal("<i class='fa fa-edit'></i> Update Status",
            "court_rentals/update_status.php?id=<?= isset($id) ? $id : '' ?>")
    })
    $('#delete-data').click(function() {
        _conf("Are you sure to delete this court_rental permanently?", "delete_court_rental", [
            '<?= isset($id) ? $id : '' ?>'
        ])
    })
})
