...
<div class="card card-outline rounded-0 card-navy">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="./?page=court_rentals/manage_court_rental"
                class="btn btn-primary bg-gradient-primary btn-flat btn-sm"><i class="fa fa-plus"></i> Create New</a>
        </div>
        <?php endif; ?>
    </div>
    <div class="card-body">
                        ...
                        <td align="center">
                            ...
                            <div class="dropdown-menu" role="menu">
                                <a class="dropdown-item view_data"
                                    href="./?page=court_rentals/view_court_rental&id=<?php echo $row['id'] ?>"><span
...
$(document).ready(function() {
    $('.delete_data').click(function() {
        _conf("Are you sure to delete this court_rental permanently?", "delete_court_rental", [$(this)
            .attr('data-id')
        ])
    })
    $('.table').dataTable({
