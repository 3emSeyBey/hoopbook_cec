    ...
    <div class="col-lg-11 col-md-11 col-sm-12 col-xs-12">
        <div class="card rounded-0 shadow">
                ...
                <div class="container-fluid">
                    <div class="container-fluid">
                        <form action="" id="court_rental-form">
                            ...
                            <input type="hidden" name="ref_number"
                                value="<?php echo isset($ref_number) ? $ref_number : '' ?>" id="ref_number">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
                                    ...
                                    <select name="court_id" id="court_id" class="form-control form-control-sm rounded-0"
                                        required="required">
                                        ...
                                        <option value="<?= $row['id'] ?>" data-price="<?= $row['price'] ?>"
                                            <?= isset($court_id) && $court_id == $row['id'] ? 'selected' : '' ?>>
                                            <?= $row['name'] ?></option>
                                        <?php endwhile; ?>
                                    </select>
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm rounded-0 text-right"
                                        id="court_price" name="court_price"
                                        value="<?= isset($court_price) ? $court_price : 0 ?>" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
                                    ...
                                    <input type="number" min="1" class="form-control form-control-sm rounded-0"
                                        id="hours" name="hours" value="<?= isset($hours) ? $hours : 1 ?>"
                                        required="required">
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm rounded-0 text-right"
                                        id="total" name="total" value="<?= isset($total) ? $total : 0 ?>" readonly>
            ...
            <div class="card-footer py-1 text-center">
                <button class="btn btn-primary btn-sm bg-gradient-primary rounded-0" form="court_rental-form"><i
                        class="fa fa-save"></i> Save</button>
                <a class="btn btn-light btn-sm bg-gradient-light border rounded-0" href="./?page=court_rentals"><i
...
function get_dt_end() {
    ...
    dt_end = dt_end.getFullYear() + "-" + ((dt_end.getMonth() + 1).toString().padStart(2, 0)) + "-" + ((dt_end
        .getDate()).toString().padStart(2, 0)) + "\T" + ((dt_end.getHours()).toString().padStart(2, 0)) + ":" + ((
        dt_end
...
$(document).ready(function() {
    ...
    $('#court_rental-form').submit(function(e) {
        ...
        var _this = $(this)
        $('.err-msg').remove();
        $('#ref_number').val(generateReferenceNumber($('#client_id').val(), $('#datetime_start').val(),
            $('#hours').val()))
        start_loader();
        $.ajax({
            url: _base_url_ +
                "classes/Master.php?f=save_court_rental<?php echo isset($id) ? '&id=' . $id : '' ?>",
