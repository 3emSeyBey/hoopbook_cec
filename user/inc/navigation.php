...
aside.main-sidebar li.nav-header {
    background: #32323a;
}
...
<aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand">
    <!-- Brand Logo -->
    <a href="<?php echo base_url ?>user" class="brand-link bg-gradient-primary text-sm" style="text-align: center;">
        <img src="<?php echo base_url ?>images/comp-logo.png" style="width: 180px; height: 50px;" />
    </a>
    <!-- Sidebar -->
    <div
