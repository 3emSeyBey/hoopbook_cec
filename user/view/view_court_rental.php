	...
	<div class="col-lg-11 col-md-11 col-sm-12 col-xs-12">
		<div class="card rounded-0 shadow">
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-danger btn-sm bg-gradient-danger rounded-0" type="button" id="delete-data"><i class="fa fa-trash"></i> Cancel</button>
				<a class="btn btn-light btn-sm bg-gradient-light border rounded-0" href="./?page=view"><i class="fa fa-angle-left"></i> Back to List</a>
			</div>
		</div>
	</div>
</div>
<script>
	$(document).ready(function(){
        ...
        $('#delete-data').click(function(){
			_conf("Are you sure to cancel this reservation permanently? This action cannot be undone.","delete_court_rental",['<?= isset($id) ? $id : '' ?>'])
		})
	})
