		...
		<table class="table table-hover table-striped table-bordered" id="list">
			...
			<tbody>
				...
				$i = 1;
					...
					$qry = $conn->query("SELECT cr.*, c.name as `court` FROM `court_rentals` cr inner join court_list c on cr.court_id = c.id WHERE cr.client_id = '$client_id' order by c.`status` asc");
				...
				?>
					<tr>
						...
						<td class="text-center">
							...
							switch($row['status']){
								case 0:
									echo '<span class="badge badge-secondary bg-gradient-secondary text-sm px-3 rounded-pill">Upcoming</span>';
									break;
								case 1:
									echo '<span class="badge badge-success bg-gradient-teal text-sm px-3 rounded-pill">Passed</span>';
									break;
							}
							?>
						</td>
						<td align="center">
								...
								<a class="dropdown-item view_data" href="./?page=view/view_court_rental&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> View</a>
